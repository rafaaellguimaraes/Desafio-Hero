	...
	return (
		<>
            ...
            boxShadow="lg"
					>
						<Text>
              <span className="text-green-500 font-semibold">Winner</span> {winner?.name}
            </Text>
						<Box
							display="flex"
						...
						>
							{selectedHero.map((hero) => (
								...
								>
									<Box>
										<Image src={hero.images.lg} alt="imagem do herói" width={200} height={150} />
									</Box>
									<Box textAlign="center">
										<Text color={"#000"} fontWeight={'bold'}>{hero.name}</Text>
									</Box>
									<Box textAlign="center">
